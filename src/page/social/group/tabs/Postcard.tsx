          ...
          {isMenuOpen && (
            <div className="absolute right-0 top-full mt-2 w-64 bg-white rounded-xl shadow-2xl border border-gray-200 py-2 z-20">
              {currentUserId === post.authorId && (
                <>
                  ...
                  >
                    ...
                    <span className="text-red-600 font-medium">Xóa bài viết</span>
                  </button>
              ...
              >
                ...
                <span className="text-gray-900 font-medium">Lưu bài viết</span>
              </button>
              <button
              ...
              >
                ...
                <span className="text-gray-900 font-medium">Ẩn bài viết</span>
              </button>
              <button
          ...
          {post.images.length === 1 ? (
            ...
            <div className="grid grid-cols-2 gap-1">
              {post.images.map((url, i) => (
                <img key={i} src={url} alt={`Post ${i + 1}`} className="w-full h-[300px] object-cover" />
              ))}
            </div>
          ) : post.images.length === 3 ? (
            <div className="grid grid-cols-2 gap-1">
              <img src={post.images[0]} alt="Post 1" className="w-full h-[400px] object-cover row-span-2" />
              <img src={post.images[1]} alt="Post 2" className="w-full h-[199px] object-cover" />
              <img src={post.images[2]} alt="Post 3" className="w-full h-[199px] object-cover" />
            </div>
          ) : (
            <div className="grid grid-cols-2 gap-1">
              {post.images.slice(0, 4).map((url, i) => (
                <div key={i} className="relative">
                  <img src={url} alt={`Post ${i + 1}`} className="w-full h-[250px] object-cover" />
      ...
      <div className="px-5 pb-3">
        ...
        <div className="border-t border-gray-200 pt-3 flex items-center">
          ...
          >
            ...
            <span className="text-base font-medium">Bình luận</span>
          </button>
          ...
          <button className="flex-1 flex items-center justify-center gap-2.5 py-3 rounded-lg hover:bg-gray-50 transition-colors group">
            ...
            <span className="text-base text-gray-700 font-medium group-hover:text-green-600">Chia sẻ</span>
          </button>
        </div>
