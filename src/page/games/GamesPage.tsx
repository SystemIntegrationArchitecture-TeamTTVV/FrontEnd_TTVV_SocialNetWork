  ...
  return (
    <div className="mx-auto max-w-3xl px-4 pb-[max(2rem,env(safe-area-inset-bottom))] pt-1 sm:px-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        >
          <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-blue-100 dark:bg-blue-500/20 text-blue-600 dark:text-blue-400 mb-4">
            <Gamepad2 className="w-7 h-7" strokeWidth={2} />
          </div>
